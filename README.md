...
├── models/
│   └── *.pkl                          # Trained model artifacts + StandardScaler
├── notebook/
│   └── Comparative_Analysis_of_...ipynb
├── tables/
│   ├── best_hyperparameters.csv       # Grid search results
│   ├── model_performance_summary.csv  # Accuracy, F1, AUC-ROC, F1 Gap per model
│   └── per_class_performance.csv      # Per-class precision, recall, F1, FN counts
└── README.md
```
...
| `combined_regularization_analysis_5models.png` | Parameter sensitivity curves |
